...
def register_blueprints(app, model_manager, session_manager, async_session_manager,
    ...
    # Register captions routes
    captions_bp = captions.init_routes(model_manager, async_session_manager)
    ...
    graph_bp = graph.init_routes(model_manager, session_manager, async_session_manager,
